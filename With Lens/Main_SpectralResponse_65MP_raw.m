...
FileNameOfBackgroundData='D:\WFOV_65MP\Spectral Response\With Lens\Monochome_08122020\Dark\dark.raw';
...
nCount=0;
RawImageFolder='D:\WFOV_65MP\Spectral Response\With Lens\Monochome_08122020\';
for(nfolder=380:10:1100)
    nCount=nCount+1;
...
fileName='D:\WFOV_65MP\Spectral Response\With Lens\Monochrometer_Light_Source\Modified.DAT';
A=readmatrix(fileName);
A=abs(A);
ResponseOfDetector=A(4:76,4);  % unit A
UnitUnderTestCurrent=A(4:76,3); % unit A/W
ResponseSivity=UnitUnderTestCurrent./ResponseOfDetector; % unit W
SpectralResponse_LS(:,1)=A(4:76,1);
